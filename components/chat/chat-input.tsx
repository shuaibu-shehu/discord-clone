...
import { EmojiPcker } from '../emoji-picker';
                ...
                <FormItem>
                    <FormControl>
                        ...
                        >
                            ...
                            bg-zinc-600 dark:bg-zinc-400 rounded-full
                            dark:hover:bg-zinc-300 hover:bg-zinc-600
                            p-1 flex items-center justify-center transition
                            ]'
                            >
                                <Plus className='text-white dark:text-[#313338]'/>
                                </button>
                                <Input
                                placeholder={`Message${type==='conversion'? name : " #" + name}`}
                                disabled={isLoading}
